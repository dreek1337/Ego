...
from src_users.application import AvatarRepo, RepoError
from src_users.application.user.exceptions import AvatarIdIsAlreadyExist
...
from src_users.infrastructure.database.models import Avatars
