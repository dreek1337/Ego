...
from src_users.application import UserIdIsAlreadyExist, UserIsNotExist
...
from src_users.presentation.api.controllers import request as req, response as resp
...
async def create_user(
    user_data: req.CreateUserRequest, service: UserService = Depends(get_service_stub)
):
    """
...
async def update_user_info(
    update_data: req.UpdateUserRequest, service: UserService = Depends(get_service_stub)
):
    """
