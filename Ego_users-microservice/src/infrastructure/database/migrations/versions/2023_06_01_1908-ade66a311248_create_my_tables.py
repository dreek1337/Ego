...
def upgrade() -> None:
    ...
    sa.Column('gender', sa.Enum('MALE', 'FEMALE', name='gendervalue'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['avatar_user_id'], ['users.user_id'], ),
    ...
    sa.ForeignKeyConstraint(['subscription_id'], ['users.user_id'], ),
